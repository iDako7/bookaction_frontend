...
export default function ProfilePage() {
  const { completedConcepts, streak } = useProgressStore();
  const totalConcepts = modulesData.reduce((sum, m) => sum + m.concepts.length, 0);
  const progress = (completedConcepts.length / totalConcepts) * 100;
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            <Card variant="elevated" padding="lg" className="text-center relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <div className="text-4xl font-bold text-gray-900 mb-2">{completedConcepts.length}</div>
            ...
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                ...
                <p className="text-gray-600 m-0">
                  {completedConcepts.length} of {totalConcepts} lessons completed
                </p>
              </div>
            </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700 m-0">
                    {completedConcepts.length === totalConcepts
                      ? '🎉 Congratulations! You\'ve completed all lessons. Keep practicing what you\'ve learned!'
                      : `You're making great progress! ${totalConcepts - completedConcepts.length} more lesson${totalConcepts - completedConcepts.length === 1 ? '' : 's'} to go.`}
                  </p>
                </div>
              </div>
            </div>
