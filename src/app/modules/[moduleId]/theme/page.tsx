...
export default function ModuleThemePage() {
  const params = useParams();
  const router = useRouter();
  const { completeTheme } = useProgressStore();
  ...
  const handleStart = () => {
    completeTheme(moduleId);
    router.push(`/concepts/${module.concepts[0].id}/intro`);
  };
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <Card variant="elevated" padding="xl">
            <div className="text-center mb-8">
              ...
              <h1 className="mb-2">{module.theme.title}</h1>
            </div>
            
            {module.theme.mediaUrl && (
              <div className="mb-8 rounded-2xl overflow-hidden shadow-2xl">
                <ImageWithFallback
                  src={module.theme.mediaUrl}
            ...
            <div className="mb-8 p-8 bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl">
              <p className="text-lg text-gray-800 leading-relaxed">{module.theme.context}</p>
            </div>
            ...
            <div className="bg-gradient-to-r from-indigo-50 to-purple-50 rounded-2xl p-8 mb-8 border-2 border-indigo-100">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700 m-0 italic text-lg">{module.theme.question}</p>
                </div>
              </div>
            </div>
