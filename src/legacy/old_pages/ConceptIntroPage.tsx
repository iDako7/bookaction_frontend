...
import { ConceptTutorial } from '../lib/mockData';
import { ImageWithFallback } from '../components/figma/ImageWithFallback';

interface ConceptIntroPageProps {
  tutorial: ConceptTutorial;
  onComplete: () => void;
  onBack: () => void;
}

export function ConceptIntroPage({ tutorial, onComplete, onBack }: ConceptIntroPageProps) {
