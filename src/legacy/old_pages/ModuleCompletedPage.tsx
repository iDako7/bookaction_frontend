...
interface ModuleCompletedPageProps {
  moduleTitle: string;
  onBackToLearn: () => void;
}

export function ModuleCompletedPage({ moduleTitle, onBackToLearn }: ModuleCompletedPageProps) {
  return (
        ...
        <div className="max-w-2xl mx-auto text-center">
          <Card variant="elevated" padding="xl">
            ...
            <p className="text-2xl text-gray-700 mb-8">
              ...
              <span className="font-bold text-[#818CF8]">{moduleTitle}</span>
            </p>
            ...
            <Button onClick={onBackToLearn} size="lg" fullWidth>
