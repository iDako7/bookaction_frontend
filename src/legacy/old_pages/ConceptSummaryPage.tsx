...
import { ConceptSummary } from '../lib/mockData';

interface ConceptSummaryPageProps {
  summary: ConceptSummary;
  conceptTitle: string;
  onContinue: () => void;
}

export function ConceptSummaryPage({ summary, conceptTitle, onContinue }: ConceptSummaryPageProps) {
  return (
          ...
          <Card variant="elevated" padding="xl">
            ...
            <div className="text-center mb-10">
              ...
              <p className="text-xl text-gray-600">
                Great job learning about <span className="font-semibold text-[#818CF8]">{conceptTitle}</span>
              </p>
            </div>
